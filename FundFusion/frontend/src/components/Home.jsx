    ...
    <Container fluid>
      ...
      <Container className="mt-5">
        <div className="slider-container">
          <h2 className="mt-5 text-center">Ongoing Campaigns</h2>
            ...
            <div>
              <Card style={{ width: "22rem" }}>
                ...
                <Card.Body>
                  ...
                  <Button variant="success"  onClick={() => navigate('/description')}>See more</Button>
                </Card.Body>
              </Card>
            </div>
            <div>
      ...
      <Container className="mt-5 DonateCar">
        <h2 className="text-center mt-5 mb-5">Our Campaigns</h2>
